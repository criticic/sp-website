            ...
            <div className="w-full max-w-[1280px] mx-auto">
                <div className="container mx-auto px-4 py-16">
                    <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                        <h2 className="mb-4 text-2xl sm:text-3xl lg:text-4xl tracking-tight font-extrabold">Contact Us</h2>
                        <p className="font-light text-base sm:text-lg lg:text-xl">Get in touch with us for any questions, concerns, or feedback.</p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mt-8 sm:mt-16">
                        <div>
                            <h2 className="text-2xl sm:text-3xl font-medium text-accent mb-6">Get in Touch</h2>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-lg sm:text-xl font-medium text-gray-800 mb-2">General Inquiries</h3>
